...
internal class LessThanEqNode : BinaryCompareNode
{
	public LessThanEqNode(IToken o) : base(o)
	{
	}

	protected override void GenTypedOp(CompileContext compileContext)
	{
		compileContext.gen.Emit(OpCodes.Cgt_Un);
	...
	protected override MethodInfo OpMethod
	{
		get
		{
			return CompileContext.op_JSValue_LTE;
		}
	}
}
