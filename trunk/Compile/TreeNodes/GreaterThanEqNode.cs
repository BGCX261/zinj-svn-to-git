...
internal class GreaterThanEqNode : BinaryCompareNode
{
	public GreaterThanEqNode(IToken o) : base(o)
	{
	}

	protected override void GenTypedOp(CompileContext compileContext)
	{
		compileContext.gen.Emit(OpCodes.Clt_Un);
	...
	protected override MethodInfo OpMethod
	{
		get
		{
			return CompileContext.op_JSValue_GTE;
		}
	}
}
