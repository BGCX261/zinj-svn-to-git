...
internal class ThrowStatement : StatementNode
{
	public ThrowStatement(IToken f) : base(f)
	{
	}

	private void GenExpr(CompileContext compileContext)
	{
	...
	{
		((ExpressionNode) base.Children[0]).GenCode(compileContext);
		compileContext.gen.Emit(OpCodes.Newobj, CompileContext.JSRuntimeException_ctor);
